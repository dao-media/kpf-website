...
final class ContentType {
	public const POST_TYPE = 'kpf_form';
	...
	public static function register_content(): void {
		register_post_type(
			...
			array(
				'labels'              => array(
					'name'          => __( 'Forms', 'kpf-core' ),
					'singular_name' => __( 'Form', 'kpf-core' ),
					'add_new_item'  => __( 'Add Form', 'kpf-core' ),
					'edit_item'     => __( 'Edit Form', 'kpf-core' ),
					'menu_name'     => __( 'Forms', 'kpf-core' ),
				),
				'description'         => __( 'Visual form definitions for the headless frontend.', 'kpf-core' ),
				'public'              => false,
				...
				'map_meta_cap'        => false,
				'capability_type'     => array( 'kpf_form', 'kpf_forms' ),
