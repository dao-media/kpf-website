	...
	public static function all(): array {
		return array(
			...
			'aggressive' => array(
				...
				'description' => __( 'Longer GraphQL/REST TTLs for this headless install. Combine/delay/unused/critical CSS stay off — those target classic wp_head and can break wp-admin.', 'kpf-core' ),
